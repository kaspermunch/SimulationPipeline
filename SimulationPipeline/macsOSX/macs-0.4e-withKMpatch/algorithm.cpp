...
void GraphBuilder::build(){
    ...
    do{
        ...
        if (pConfig->bNewickFormat){
            double iSegLength = (curPos-lastPos)*pConfig->dSeqLength;
//			unsigned int iSegLength = (curPos-lastPos)*pConfig->dSeqLength;
//			unsigned int iSegLength = floor(0.5+(curPos-lastPos)*pConfig->dSeqLength);
